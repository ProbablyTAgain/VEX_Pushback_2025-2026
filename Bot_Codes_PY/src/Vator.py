...
def arcade_drive():
    ...
    while True:
        ...
        # intake control 
        if R1pressed:
            IntakeT.spin(FORWARD, V, VelocityUnits.PERCENT)
        elif L1pressed:
            IntakeT.spin(REVERSE, V, VelocityUnits.PERCENT)
        elif Xpressed:
            IntakeB.spin(REVERSE, 100, VelocityUnits.PERCENT)
            IntakeT.spin(REVERSE, 100, VelocityUnits.PERCENT)
        elif Bpressed:
            ...
            IntakeB.spin(FORWARD, V, VelocityUnits.PERCENT)
            
        elif L2pressed:
           IntakeB.spin(REVERSE, V, VelocityUnits.PERCENT)
...
if __name__ == "__main__":
    ...
    Competition(arcade_drive,autonomous)
